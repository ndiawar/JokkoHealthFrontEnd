export const MENUITEMS = [
  ...
  },
  {
    ...
    menucontent: "Gestion des utilisateurs",
    Items: [
      {
        title: "Utilisateurs",
        icon: "user",
        ...
        active: false,
        children: [
          { path: `${process.env.PUBLIC_URL}/user/user-list`, type: "link", title: "User-List" },
          { path: `${process.env.PUBLIC_URL}/user/new-user`, type: "link", title: "Create New" },
        ],
      },
    ]
  },
