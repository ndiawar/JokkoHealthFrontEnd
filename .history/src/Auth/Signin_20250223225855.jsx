...
const Signin = ({ selected }) => {
  ...
  const divStyle = {
    backgroundImage: "url('/assets/images/login/jooko.png')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    height: "100vh", // Vous pouvez ajuster la hauteur selon votre besoin
  };
  ...
  return (
    <Fragment>
      <Container fluid={true} className="p-0 login-page">
        <Row>
          <Col xs="12">
            <div className="login-card" style={divStyle}>
