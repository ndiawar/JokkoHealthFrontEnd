...
export const EmailAddress = "Adresse Email";
...
export const SignIn = "Connexion";
export const SignUp = "Inscription";
export const CreateAccount = "Créer un compte";
...
export const CHECKALL = "Voir tous";
...
export const Account = "Mon Profil";
